...
RCT_EXTERN_METHOD(setData:(NSString *)key data:(id)data success:(RCTPromiseResolveBlock)success reject:(RCTPromiseRejectBlock)reject);
RCT_EXTERN_METHOD(saveData:(NSString *)key data:(id)data success:(RCTPromiseResolveBlock)success reject:(RCTPromiseRejectBlock)reject);
